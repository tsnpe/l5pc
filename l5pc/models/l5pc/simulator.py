...
import os
import pandas as pd
from multicompartment.models.l5pc import l5pc_model
from multicompartment.models.l5pc import l5pc_evaluator
from multicompartment.models.l5pc.utils import (
    return_gt,
    return_names,
...
def setup_l5pc(load_libraries: bool = True):
    ...
    path = "/home/michael/Documents/multicompartment_collection/multicompartment/multicompartment/models/l5pc/"
